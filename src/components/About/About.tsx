      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-card border border-divider rounded-2xl p-6">
          ...
          <p className="text-muted leading-relaxed mb-3">
            Getting a first reptile or amphibian should feel exciting, not overwhelming. We built
            Habitat Builder to turn real care requirements into a clear, step-by-step plan so you
            can feel confident from day one.
          </p>
          <p className="text-muted leading-relaxed">
            The tool is <strong className="text-accent">free to use</strong> for the core planner.
            Premium features like the Care Calendar, animal tracking, and inventory management are
            available with a{' '}
            ...
            {[
              {
                ...
                desc: 'Choose from popular species with verified care requirements. Not sure what fits your space? Use the Find Your Animal tool.',
              },
              {
                icon: Ruler,
                title: 'Enter Your Dimensions',
                desc: 'Input your enclosure size and get it validated against species minimums, enclosure type, and your setup preferences.',
              },
              {
                icon: Sparkles,
                title: 'Get Your Custom Plan',
                desc: 'Receive a complete shopping list, layout diagram, care targets, substrate guide, and step-by-step build instructions.',
              },
        ...
        <div className="bg-card border border-divider rounded-2xl p-6">
            ...
            {[
              {
                ...
                detail: 'UVB output, wattage, and coverage specs',
              },
              {
                label: 'Community expertise',
                detail: 'Input from experienced keepers and hobbyists',
              },
              {
                label: 'Scientific literature',
                detail: 'Thermal biology and natural habitat research',
              },
            ].map(({ label, detail }) => (
          ...
          <div className="bg-accent/10 border border-accent/30 rounded-xl p-4 flex items-start gap-3">
            ...
            <p className="text-sm text-white/80 leading-relaxed">
              ...
              <strong className="text-white">math-based, not AI guesses</strong> -- we use formulas
              for enclosure volume, temperature delta, and UVB coverage to calculate sizing.
            </p>
          </div>
        </div>
        ...
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6">
          ...
          <ul className="space-y-2 text-sm text-amber-200/80">
            <li>
              We are not vets -- if your animal seems unwell, consult a reptile-specialist vet
            </li>
            <li>
              Every animal is different; age, health, and environment all affect what you will need
            </li>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="bg-card border border-divider rounded-2xl p-5 flex flex-col gap-3">
            ...
            <p className="text-muted text-sm flex-1">
              Check the FAQ for answers to common questions about the tool and reptile care.
            </p>
            <Link
              to="/faq"
          ...
          <div className="bg-card border border-divider rounded-2xl p-5 flex flex-col gap-3">
            ...
            <p className="text-muted text-sm flex-1">
              We read every message. Ideas, bug reports, and species requests are all welcome.
            </p>
            <button
        ...
        <div className="text-center text-muted text-sm pb-6">
          <Link to="/whats-new" className="text-accent hover:underline">
            View what's new
          </Link>
          {' -- '}
