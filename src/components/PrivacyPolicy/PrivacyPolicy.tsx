      ...
      <div className="max-w-4xl mx-auto space-y-8 pb-12">
        ...
        <div className="bg-card rounded-lg shadow-md p-6">
          ...
          <p className="text-secondary leading-relaxed">
            ...
            or from your <Link to="/profile" className="text-accent underline hover:no-underline">Profile</Link> page.
          </p>
        </div>
        ...
        <div className="bg-card rounded-lg shadow-md p-6">
          ...
          <p className="text-secondary leading-relaxed mt-4">
            ...
            <Link to="/about" className="text-accent underline hover:no-underline">About page</Link>.
          </p>
        </div>
        ...
        <div className="text-center text-muted text-sm pb-4">
          <p>Questions? Use the feedback form on the <Link to="/about" className="text-accent underline hover:no-underline">About page</Link>.</p>
        </div>
      </div>
    </>
  );
