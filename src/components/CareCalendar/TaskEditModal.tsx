...
export function TaskEditModal({ task, isOpen, onClose, onTaskUpdated }: TaskEditModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-3 sm:space-y-4">
          ...
          {enclosures.length > 0 && (
            <div>
              <label htmlFor="enclosure" className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 sm:mb-2">
                Enclosure
              </label>
              <select
                id="enclosure"
                ...
                className="w-full px-2 sm:px-3 py-1.5 sm:py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm sm:text-base"
              >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-4">
            ...
            <div>
              <label htmlFor="frequency" className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 sm:mb-2">
                Frequency
              </label>
              <select
                id="frequency"
            ...
            <div className="col-span-2 sm:col-span-1">
              <label htmlFor="scheduledTime" className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 sm:mb-2">
                Time
              </label>
              <input
                id="scheduledTime"
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-3 sm:pt-4">
            <h3 className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white mb-2 sm:mb-3">Notification Settings</h3>
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              {formData.notificationEnabled && (
                <div>
                  <label htmlFor="notificationMinutes" className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 sm:mb-2">
                    Remind me
                  </label>
                  <select
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 p-3 sm:p-4 bg-gray-50 dark:bg-gray-900">
          ...
          <div className="sm:hidden space-y-2">
            <button
              ...
              className="w-full px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-medium transition-colors disabled:opacity-50 shadow-sm text-sm flex items-center justify-center"
            >
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 px-4 py-2.5 text-red-600 hover:text-white dark:text-red-400 bg-red-50 hover:bg-red-600 dark:bg-red-900/20 dark:hover:bg-red-600 rounded-lg transition-colors disabled:opacity-50 font-medium text-sm border border-red-200 dark:border-red-800"
              >
              ...
              <button
                ...
                disabled={loading}
                aria-label="Cancel"
                className="flex-1 px-4 py-2.5 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 border border-gray-300 dark:border-gray-600 rounded-lg transition-colors disabled:opacity-50 font-medium text-sm"
              >
