...
export function FeedingLogModal({ isOpen, taskTitle, onClose, onSubmit, task }: FeedingLogModalProps) {
  ...
  return (
    <ModalPortal>
      <div className="fixed inset-0 bg-black/60 flex items-start justify-center z-50 p-4 pt-[max(1rem,env(safe-area-inset-top))] sm:pt-[8vh] overflow-y-auto overscroll-contain">
        <div className="bg-card rounded-2xl shadow-xl max-w-2xl w-full max-h-[85vh] overflow-hidden flex flex-col">
          {/* Header */}
