  ...
  return (
    <div className="bg-card rounded-lg border border-divider p-3 sm:p-6">
      <div className="flex items-center justify-between mb-3 sm:mb-4">
        ...
        <div className="flex items-center gap-1 sm:gap-2 text-xs text-muted">
          ...
          <div className="flex gap-0.5 sm:gap-1">
            ...
            <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 bg-accent dark:bg-accent/80 rounded-sm"></div>
      ...
      <p className="text-xs text-muted mt-3 sm:mt-4">
        Each square represents a day. Lighter colors mean more completed tasks.
      </p>
    </div>
  );
}
