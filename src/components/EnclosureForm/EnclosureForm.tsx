...
export function EnclosureForm({ value, onChange, animalProfile }: EnclosureFormProps) {
  ...
  return (
    <div className="bg-card rounded-lg shadow-md p-4 lg:p-6 space-y-6">
          ...
          <button
            ...
            className={`group relative overflow-hidden rounded-xl px-3 py-4 sm:px-4 sm:py-5 text-sm font-medium transition-all duration-200 ${
              value.setupTier === 'minimum'
                ...
                : 'bg-card border-2 border-slate-200 dark:border-divider hover:border-slate-300 dark:hover:border-slate-600 hover:shadow-md hover:scale-[1.01]'
            }`}
          >
            <div className="flex flex-col items-center text-center">
              <CheckCircle className={`w-8 h-8 mb-2 transition-colors ${
                value.setupTier === 'minimum' 
                  ...
                  : 'text-slate-400 dark:text-muted group-hover:text-slate-500 dark:group-hover:text-slate-400'
              }`} />
          ...
          <button
            ...
            className={`group relative overflow-hidden rounded-xl px-3 py-5 sm:px-4 sm:py-6 text-sm font-medium transition-all duration-200 ${
              value.setupTier === 'recommended'
                ...
                : 'bg-card border-2 border-amber-200 dark:border-amber-900/40 hover:border-amber-300 dark:hover:border-amber-700 hover:shadow-lg hover:shadow-amber-100/50 dark:hover:shadow-amber-900/20 hover:scale-[1.03] sm:hover:scale-[1.08]'
            }`}
          >
            {/* Popular Badge */}
          ...
          <button
            ...
            className={`group relative overflow-hidden rounded-xl px-3 py-4 sm:px-4 sm:py-5 text-sm font-medium transition-all duration-200 ${
              value.setupTier === 'ideal'
                ? 'bg-gradient-to-br from-emerald-100 to-green-200 dark:from-emerald-900/50 dark:to-green-900/50 border-2 border-accent dark:border-accent shadow-lg shadow-emerald-200/50 dark:shadow-emerald-900/30 scale-[1.02]'
                : 'bg-card border-2 border-accent/30 dark:border-emerald-900/40 hover:border-accent/30 dark:hover:border-accent/30 hover:shadow-md hover:shadow-emerald-100/50 dark:hover:shadow-emerald-900/20 hover:scale-[1.01]'
            }`}
          >
            <div className="flex flex-col items-center text-center">
              <Award className={`w-8 h-8 mb-2 transition-colors ${
                value.setupTier === 'ideal' 
                  ? 'text-accent' 
                  : 'text-accent dark:text-accent group-hover:text-accent dark:group-hover:text-accent'
              }`} />
      ...
      <div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="w-12 h-12 lg:w-10 lg:h-10 rounded-lg bg-card-elevated active:bg-card-elevated dark:active:bg-gray-600 text-white font-bold text-xl transition-colors flex items-center justify-center"
          ...
          <input
            ...
            min="1"
            max="20"
            className="w-20 px-3 py-3 lg:py-2 border-2 border-divider dark:bg-card-elevated dark:text-white rounded-lg text-center font-medium text-lg focus:ring-2 focus:ring-jade-500 focus:border-transparent"
          />
          <button
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-1.5">
          {presetsToShow.map((preset) => {
            ...
            let buttonStyles = '';
            if (isSelected) {
              buttonStyles = 'bg-jade-600 text-white shadow-md';
            } else if (preset.name === 'Custom') {
              buttonStyles = 'bg-card-elevated text-white hover:bg-card-elevated';
            } else if (validationStatus === 'good') {
              buttonStyles = 'bg-accent/10 text-accent border border-accent/30 hover:bg-accent/15 dark:hover:bg-emerald-900/30';
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-divider dark:bg-card-elevated dark:text-white rounded-md focus:ring-2 focus:ring-jade-500 focus:border-transparent"
                min="0"
                step={isMetric ? '1' : '0.1'}
              />
            </div>
      ...
      <div className="space-y-3 pt-4 border-t border-divider">
        <label className="flex items-center gap-3 cursor-pointer">
          <input
            ...
            className="w-5 h-5 text-jade-600 border-divider rounded focus:ring-jade-500"
          />
          <div>
        ...
        <>
          ...
          <div className="col-span-full">
            <div className="border-t-2 border-accent/30 dark:border-accent pt-6 mt-2">
              ...
              <p className="text-sm text-muted mb-4">Help us find animals that match your experience and lifestyle</p>
            </div>
          </div>
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-3 py-2 border border-divider dark:bg-card-elevated dark:text-white rounded-md focus:ring-2 focus:ring-jade-500"
        >
          {animalProfile?.equipmentNeeds?.waterFeature === 'fully-aquatic' && (
      ...
      <div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="w-10 h-10 rounded-md bg-card-elevated hover:bg-card-elevated text-white font-bold transition-colors flex items-center justify-center"
          ...
          <input
            ...
            min="1"
            max="6"
            className="w-20 px-3 py-2 border border-divider dark:bg-card-elevated dark:text-white rounded-md text-center font-medium focus:ring-2 focus:ring-jade-500 focus:border-transparent"
          />
          <button
