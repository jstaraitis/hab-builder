  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-white">Shopping List & Supplies</h2>
          <p className="text-sm text-muted">Everything you need to build and maintain your enclosure</p>
        </div>
      ...
      <div className="bg-sky-500/10 border-2 border-blue-200 dark:border-blue-800 rounded-xl p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-secondary">
            <p className="font-semibold text-white mb-1">Supporting Habitat Builder</p>
