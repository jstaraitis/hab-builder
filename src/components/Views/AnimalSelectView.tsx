        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-card rounded-xl shadow-2xl max-w-md w-full p-6 relative">
            <button
              ...
              className="absolute top-4 right-4 text-muted hover:text-muted dark:hover:text-gray-200 transition-colors"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 p-2 md:p-3 bg-card dark:bg-card-elevated rounded-xl">
            {selectedProfile.adultSize && (
              <div>
                ...
                <p className="text-sm font-semibold text-white">{selectedProfile.adultSize}</p>
              </div>
            )}
            {selectedProfile.temperament && (
              <div>
                <p className="text-xs text-muted uppercase tracking-wide mb-0.5">Temperament</p>
                <p className="text-sm font-semibold text-white">{selectedProfile.temperament}</p>
              </div>
            )}
            {selectedProfile.originRegion && (
              <div className="md:col-span-2">
                <p className="text-xs text-muted uppercase tracking-wide mb-0.5">Natural Habitat</p>
                <p className="text-sm font-semibold text-white">{selectedProfile.originRegion}</p>
              </div>
            )}
