          ...
          <ul className="space-y-3">
            {block.items?.map((item, itemIndex) => (
              <li key={`${index}-${itemIndex}`} className="flex items-start gap-3">
                ...
                <span
                  className="text-secondary leading-relaxed flex-1"
    ...
    case 'table':
      return (
        <div key={index} className="mb-10">
          {/* Desktop table */}
          <div className="hidden md:block overflow-hidden rounded-xl border border-divider">
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-divider dark:divide-gray-700">
                ...
                <tbody className="bg-surface divide-y divide-divider dark:divide-gray-700">
                  {block.rows?.map((row, rowIndex) => (
                    <tr key={`${index}-row-${rowIndex}`} className="hover:bg-card">
