              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 sm:gap-3 lg:gap-4">
                {regularGuides.map((blog) => (
                  ...
                  >
                    ...
                    <h4 className="font-semibold text-gray-900 dark:text-white group-hover:text-jade-700 dark:group-hover:text-jade-300 mb-1">
                      {blog.title}
                    </h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-2 line-clamp-2">
                      {blog.excerpt}
            ...
            <button
              ...
              className={`px-3 sm:px-4 py-2 rounded-lg font-semibold border-2 transition-all ${
                selectedAnimal === animal.id
                  ...
                  : 'border-gray-300 dark:border-gray-600 hover:border-jade-400 dark:hover:border-accent bg-white dark:bg-gray-700 text-gray-800 dark:text-white hover:scale-105'
              }`}
            >
              {animal.commonName}
            </button>
