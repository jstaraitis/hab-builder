        ...
        <div className="max-w-7xl mx-auto px-4 py-4 md:py-6 text-center">
          ...
          <div className="mt-4 md:mt-6 pt-4 md:pt-6 border-t border-divider">
            <div className="flex items-center justify-center gap-4 mb-3 md:mb-4">
              <a href="https://www.instagram.com/frog_habitat_builder" target="_blank" rel="noopener noreferrer" className="p-1.5 md:p-2 rounded-xl bg-card-elevated text-muted hover:bg-pink-900/30 hover:text-pink-400 transition-colors" title="Follow us on Instagram">
                <Instagram className="w-4 h-4 md:w-5 md:h-5" />
              </a>
              <a href="https://www.tiktok.com/@habitat.builder" target="_blank" rel="noopener noreferrer" className="p-1.5 md:p-2 rounded-xl bg-card-elevated text-muted hover:bg-white/10 hover:text-white transition-colors" title="Follow us on TikTok">
